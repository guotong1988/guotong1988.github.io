...
If we manually review the training dataset by LLMs API to identify and correct the error data, this method would consume a significant amount of annotation manpower.
