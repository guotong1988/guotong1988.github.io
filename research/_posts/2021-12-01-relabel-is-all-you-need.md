...
Why re-label method work? Because deep learning is statistic-based. Take classification as example. If there are three \textbf{very similar} data (data-1/data-2/data-3) in total, which labels are class-A/class-A/class-B, Then the trained model will predict class-A for data-3.
