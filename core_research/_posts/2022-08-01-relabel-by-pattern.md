...
**If the model predicted result is wrong for a new evaluation data. Then the new evaluation data's most similar data in the training dataset must be wrong.**
