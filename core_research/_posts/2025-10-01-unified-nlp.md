...
```mermaid
flowchart TB
    subgraph Inst["Instance-level relabeling"]
        direction LR
    ...
    subgraph Prompt["Prompt-level relabeling"]
        direction LR
