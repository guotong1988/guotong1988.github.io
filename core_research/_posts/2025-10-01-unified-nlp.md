...
*Table 5. Two prompt-level loops. All numbers are the test accuracy of the small model. Row 2 is the LLM-prompt loop of Section 3.3; row 3 is the small-model loop of Section 3.4.*
