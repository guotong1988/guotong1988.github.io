...
## 4. Discussion
The text2code approach has a lot of potential, because, in fact, all natural languages have their logical forms. We can design specialised code for the application, for example SQL is a kind of code for the application.
